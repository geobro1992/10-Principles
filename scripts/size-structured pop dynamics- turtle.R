...
Tmax=500 #max years
Tfishing=300 #when we start fishing
...
recruitsize=10
Amax=50 #max age
amat=25 #age at maturation - this varies depending on the matration function chosen

Linf=120 #max size
k=.04   # Growth function param
fishingsize = .75*Linf #size-selective fishery threshold size 


M=0.09   #natural mortality coef  

c=1.43   #egg slope 
d=-14.4   #egg intercept
