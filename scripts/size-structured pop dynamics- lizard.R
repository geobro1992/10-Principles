...
recruitsize=1
Amax=4 #max age
amat=1.5 #age at maturation - this varies depending on the matration function chosen

Linf=12 #max size
k=1.5   # Growth function param
fishingsize = .75*Linf #size-selective fishery threshold size 


M=1.08   #natural mortality coef  
...
par(bg=NA)
plot(1:Tmax, sums, type="l", lwd = 10, col = "#7570b3", axes = F, xlab="", ylab="")

dev.copy(png,'lizard.png')
dev.off()
